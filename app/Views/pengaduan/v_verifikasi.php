	...
	<div class="content">
		...
		<div class="block block-themed">
			 <div class="block-header bg-gd-sea">
				<h3 class="block-title">VERIFIKASI PENGADUAN</h3>
			...
			<div class="block-content">
				<form action="<?php echo site_url('adminpengaduan/proses_verifikasi/'.$row->id_pengaduan);?>" method="post" enctype="multipart/form-data">
