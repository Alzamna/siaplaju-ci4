	...
	<div class="content">
		...
		<div class="block block-themed">
			 <div class="block-header bg-gd-sea">
				<h3 class="block-title">TAMBAH LAMPU PJU</h3>
					...
					<div class="row">
                        <div class="col-sm-6">														
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="id_pel" name="id_pel" placeholder="ID Pelanggan">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="no_gardu" name="no_gardu" placeholder="Nomor Gardu">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="no_pal" name="no_pal" placeholder="Nomor PAL">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="jenis" name="jenis" placeholder="Jenis Lampu">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="kwh" name="kwh" placeholder="KWH">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="daya" name="daya" placeholder="Daya Lampu">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="posisi" name="posisi" placeholder="Posisi Tiang">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="kondisi" name="kondisi" placeholder="Kondisi Lampu">
								</div>
							</div>
