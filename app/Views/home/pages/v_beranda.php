	...
	<div class="fullwidthbanner" data-height="300" data-shadow="0" data-navigationStyle="preview2">
		<ul class="hide">
			...
			<li data-transition="random" data-slotamount="1" data-masterspeed="1000" data-delay="5000" data-saveperformance="off" data-title="Slide 1">
				<img src="<?php echo base_url('home/images/1x1.png')?>" data-lazyload="<?php echo base_url('home/images/slider/slider1.jpg')?>" alt="" data-bgfit="cover" data-bgrepeat="no-repeat" />
			</li>
			...
			<li data-transition="random" data-slotamount="1" data-masterspeed="1000" data-delay="5000" data-saveperformance="off" data-title="Slide 2">
				<img src="<?php echo base_url('home/images/1x1.png')?>" data-lazyload="<?php echo base_url('home/images/slider/slider2.jpg')?>" alt="" data-bgfit="cover" data-bgrepeat="no-repeat" />
			</li>
			
			<li data-transition="random" data-slotamount="1" data-masterspeed="1000" data-delay="5000" data-saveperformance="off" data-title="Slide 2">
				<img src="<?php echo base_url('home/images/1x1.png')?>" data-lazyload="<?php echo base_url('home/images/slider/slider3.jpg')?>" alt="" data-bgfit="cover" data-bgrepeat="no-repeat" />
			</li>
		</ul>
...
<section class="nopadding">
	<img class="img-responsive" src="<?php echo base_url('home/images/jargon.png');?>" alt="">
</section>
			...
			<div class="row text-center">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<a href="<?php echo site_url('pengaduan');?>">
						<img class="img-responsive" style="height:150px;width:auto" src="<?php base_url('home/images/icon/pengaduan-icon.jpg');?>" alt="" />
						<div class="caption text-center margin-top-10">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<a href="<?php echo site_url('aspirasi');?>">
						<img class="img-responsive" style="height:150px;width:auto" src="<?php base_url('home/images/icon/aspirasi-icon.jpg');?>" alt="" />
						<div class="caption text-center margin-top-10">
