		...
		<div class="row text-center">
			<div class="col-md-4 col-md-offset-4">
				<div class="form-group">
					<a href="<?php echo site_url('pengaduan/input')?>" class="btn btn-3d btn-blue">
					...
					<div class="panel <?php echo $panel;?>">
						...
						<div class="panel-body">
							...
							<?php if($row->foto==""){ ?>
								Tidak ada foto
							<?php } else { ?>
								<img class="img-responsive" src="<?php echo base_url('upload/foto/pengaduan/'.$row->foto);?>" alt="image" />
							<?php }?>
								<hr/>
